  ...
  useEffect(() => {
    async function loadDetail() {
      ...
      try {
        ...
        setError(err instanceof ApiError ? err.message : "Unable to load package");
      } finally {
        setIsLoading(false);
      }
    }
  ...
  return (
    <div className="mx-auto max-w-5xl">
      ...
      <section className="mt-6 grid gap-4 md:grid-cols-4">
        ...
        <div className="rounded-md border border-slate-200 bg-white p-4">
          <p className="text-xs font-semibold uppercase text-slate-500">Premium</p>
        ...
        <div className="rounded-md border border-slate-200 bg-white p-4">
          ...
          <p className="mt-2 font-semibold capitalize">{packageItem.status}</p>
        </div>
      </section>
